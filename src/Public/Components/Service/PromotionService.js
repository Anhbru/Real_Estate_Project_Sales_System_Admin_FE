...
class PromotionService {
    ...
    adminListPromotions = () => {
        ...
        return axios.get(BASE_URL_SERVER + API_ENDPOINT.ADMIN_LIST_PROMOTIONS, config);
    }
    ...
    adminDetailPromotion = (id) => {
        ...
        return axios.get(BASE_URL_SERVER + API_ENDPOINT.ADMIN_DETAIL_PROMOTION + id, config);
    }
    ...
    adminCreatePromotion = (data) => {
        ...
        return axios.post(BASE_URL_SERVER + API_ENDPOINT.ADMIN_POST_PROMOTION, data, config);
    };
    ...
    adminDeletePromotion = (id) => {
        ...
        return axios.delete(BASE_URL_SERVER + API_ENDPOINT.ADMIN_DELETE_PROMOTION + id, config);
    }
}
