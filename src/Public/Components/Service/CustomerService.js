...
class CustomerService {
  ...
  adminListCustomer = () => {
    ...
    return axios.get(
      BASE_URL_SERVER + API_ENDPOINT.ADMIN_LIST_CUSTOMER,
      config
    );
  };
  ...
  adminDetailCustomer = (id) => {
    ...
    return axios.get(
      BASE_URL_SERVER + API_ENDPOINT.ADMIN_DETAIL_CUSTOMER + id,
      config
    );
  };
  ...
  adminCreateCustomer = (data) => {
    ...
    return axios.post(
      BASE_URL_SERVER + API_ENDPOINT.ADMIN_POST_CUSTOMER,
      data,
      config
    );
  };
  ...
  adminUpdateCustomer = (id, data) => {
    ...
    return axios.put(
      BASE_URL_SERVER + API_ENDPOINT.ADMIN_UPDATE_CUSTOMER + id,
      data,
      config
    );
  };
  ...
  adminDeleteCustomer = (id) => {
    ...
    return axios.delete(
      BASE_URL_SERVER + API_ENDPOINT.ADMIN_DELETE_CUSTOMER + id,
      config
    );
  };
}
