...
class SalesPolicyService {
  adminListSalesPolicy = () => {
    ...
    return axios.get(
      BASE_URL_SERVER + API_ENDPOINT.ADMIN_LIST_SALES_POLICY,
      config
    );
  };
  ...
  adminDetailSalesPolicy = (id) => {
    ...
    return axios.get(
      BASE_URL_SERVER + API_ENDPOINT.ADMIN_DETAIL_SALES_POLICY + id,
      config
    );
  };
  ...
  adminCreateSalesPolicy = async (data) => {
    ...
    try {
      const response = await axios.post(
        BASE_URL_SERVER + API_ENDPOINT.ADMIN_POST_SALES_POLICY,
        data,
        config
      );
      return response;
      ...
      if (error.response) {
        ...
        throw new Error(
          error.response.data.message || "Error creating sales policy"
        );
      } else {
  ...
  adminUpdateSalesPolicy = (id, data) => {
    ...
    return axios.put(
      BASE_URL_SERVER + API_ENDPOINT.ADMIN_UPDATE_SALES_POLICY + id,
      data,
      config
    );
  };
  ...
  adminDeleteSalesPolicy = (id) => {
    ...
    return axios.delete(
      BASE_URL_SERVER + API_ENDPOINT.ADMIN_DELETE_SALES_POLICY + id,
      config
    );
  };
}
