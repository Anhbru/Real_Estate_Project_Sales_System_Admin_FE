          ...
          <div className="content_page_">
            ...
            >
              <div className="form_area_">
                <div className="title_form_">
                  Contract Payment Detail Information
                </div>
                ...
                <div className="form-group mt-3">
                  ...
                  <input
                    ...
                    name="paidValueLate"
                    id="paidValueLate"
                    placeholder="Enter Paid Value Late"
                  />
                </div>
              ...
              <div className="footer_form_">
                <BackButton />
                <button className="btn_create" id="btnCreate" type="submit">
                  Save
                </button>
              </div>
            </Form>
