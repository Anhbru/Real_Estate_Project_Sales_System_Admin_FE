...
function ContractDetail() {
    ...
    const detailContract = async () => {
        await contractService.getDetail(id)
            .then((res) => {
                    ...
                    <div className="content_page_">
                        <div className="info_area_">
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <a href={"/contract/edit/" + contract.contractID} className="edit_tab_">Edit</a>
                            </div>
                            ...
                            <div className="content_">
                                ...
                                <div className="row">
                                    ...
                                    <div className="d-flex align-items-center justify-content-start col-md-4">
                                        ...
                                        <p className="val_ text-truncate">{ConvertNumber(contract.totalPrice)}</p>
                                    </div>
                                    <div className="d-flex align-items-center justify-content-start col-md-4">
                                ...
                                <div className="row">
                                    <div className="d-flex align-items-center justify-content-start">
                                        ...
                                        <p className="val_ text-truncate">{contract.documentName}</p>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="d-flex align-items-center justify-content-start">
                ...
                <div className="modal-dialog modal-dialog-centered modal-lg">
                    ...
                    <div className="modal-header">
                        ...
                        <div className="modal-body">
                            <div className="row">
                                <div className="row">
                                    <img src={contract.imageContract} alt=""
