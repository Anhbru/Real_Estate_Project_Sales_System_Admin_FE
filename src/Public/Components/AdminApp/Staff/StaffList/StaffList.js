            ...
            <main id="main" className="main">
                ...
                <section className="section">
                    <div className="d-flex justify-content-between align-items-center">
                        <input type="text" className="input_search" placeholder="Search staff" />
                                                    ...
                                                    <td>
                                                        <p className="nav-item dropdown">
                                                            ...
                                                            <ul className="dropdown-menu">
                                                                <li>
                                                                    <a className="dropdown-item" href={'/staff/detail/' + item.staffID}>Detail</a>
                                                                </li>
                                                                <li><hr className="dropdown-divider" /></li>
                                                                <li>
                                                                    <a className="dropdown-item" href={'/staff/update/' + item.staffID}>Update</a>
                                                                </li>
                                                                <li><hr className="dropdown-divider" /></li>
                                                                <li>
                                                                    <button
