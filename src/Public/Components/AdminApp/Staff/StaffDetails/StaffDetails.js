                    ...
                    <div className="content_page_">
                        <div className="info_area_">
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <Link to={`/staff/update/${staff.staffID}`} className="edit_tab_">Edit</Link>
                            </div>
                            <div className="content_">
                                <div className="row">
                                    ...
                                    <div className="d-flex align-items-center justify-content-start col-md-6">
                                        ...
                                        <p className="val_ text-truncate">{staff.dateOfBirth}</p>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="d-flex align-items-center justify-content-start col-md-6">
                                        <p className="key_">ID Card: </p>
                                        <p className="val_ text-truncate">{staff.identityCardNumber}</p>
                                    </div>
                                    <div className="d-flex align-items-center justify-content-start col-md-6">
                                        <p className="key_">Nationality: </p>
                                        <p className="val_ text-truncate">{staff.nationality}</p>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="d-flex align-items-center justify-content-start col-md-6">
                                        <p className="key_">Address: </p>
                                        <p className="val_ text-truncate">{staff.placeOfResidence}</p>
                                    </div>
                                    <div className="d-flex align-items-center justify-content-start col-md-6">
                                        <p className="key_">Place Of Origin: </p>
                                        <p className="val_ text-truncate">{staff.placeOfOrigin}</p>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="d-flex align-items-center justify-content-start col-md-6">
