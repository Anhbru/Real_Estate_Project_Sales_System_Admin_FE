...
function ZoneList() {
    ...
    const getListZone = async (page) => {
        await zoneService.adminListZone(page)
            .then((res) => {
                if (res.status === 200) {
            ...
            <main id="main" className="main">
                ...
                <section className="section">
                    <div className="d-flex justify-content-between align-items-center">
                        <input type="text" className="input_search" placeholder="Search zones name"/>
                            ...
                            <tbody>
                            {
                                data.map((item, index) => {
                                    return (
                                        <tr key={index}>
                                            <td>{index + 1}</td>
                                            <td> <img src={item.imageZone} alt=""/> </td>
                                                ...
                                                <p className="nav-item dropdown">
                                                    ...
                                                    <ul className="dropdown-menu">
                                                        <li><a className="dropdown-item"
                                                               href={'/zones/detail/' + item.zoneID}>Detail
                                                            zones</a></li>
                                                        <li>
                                                            <hr className="dropdown-divider"/>
                                                        </li>
                                                        <li><a className="dropdown-item"
                                                               href={'/zones/update/' + item.zoneID}>Update
                                                            zones</a></li>
                                                        <li>
                                                            <hr className="dropdown-divider"/>
                                                        </li>
                                                        <li><a className="dropdown-item" href="/zones/create">Create
                                                            zones</a></li>
                                                    </ul>
                                                </p>
                                            </td>
