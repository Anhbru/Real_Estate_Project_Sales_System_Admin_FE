...
import ContractHistoryDetail from "./Components/AdminApp/ContractHistory/ContractHistoryDetail/ContractHistoryDetail";
function Public() {
  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={<PropertyCategoryList />}
      />
      <Route
        path="/property-categories/create"
        element={<PropertyCategoryCreate />}
      />
      <Route
        path="/property-categories/update/:id"
        element={<PropertyCategoryUpdate />}
      />
      <Route
        path="/property-categories/detail/:id"
        element={<PropertyCategoryDetail />}
      />
      {/* OpenForSales Page */}
      ...
      <Route
        path="/contractHistory/list/:contractID"
      ...
      />
      <Route
        path="/contractHistory/detail/:id"
        element={<ContractHistoryDetail />}
      />
    </Routes>
  );
}
