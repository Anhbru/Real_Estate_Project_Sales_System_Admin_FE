...
import OpenForSaleDetailAllList
    from './Components/AdminApp/OpenForSaleDetail/OpenForSaleDetail/OpenForSaleDetailAllList';
...
import PromotionDetailListByPromotionID
    from './Components/AdminApp/PromotionDetail/PromotionListByPromotionID/ProtionListByPromtionID';
...
import OpenForSaleDetailUpdate
    from './Components/AdminApp/OpenForSaleDetail/OpenForSaleDetailDetail/OpenForSaleDetailDetail';
...
function Public() {
    ...
    return (
        <Routes>
            ...
            <Route path='/openforsaledetails/update/:propertyID/:openingForSaleID'
